...
const includedFeatures = [
    'Private key to the purchased product',
...
const ArticleContent = () => {
    return (
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
            ...
            <div className="mx-auto max-w-2xl object-left-top">
                <Image src={Picture}
                       className={"object-contain"}
                       alt={"Thumbnail"}
                />
            </div>
            <div className="mx-auto mt-12 max-w-2xl rounded-3xl ring-1 ring-gray-200 sm:mt-10 lg:mx-0 lg:flex lg:max-w-none">
